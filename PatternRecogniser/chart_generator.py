...
def create_visualisation(data, output_path):
   ...
   # Subplot 2: Success Rate by Difficulty Level
    ...
    _ = ax3.bar(x_pos, success_counts, color='#2ecc71', alpha=0.8, label='Success', edgecolor='black')
    _ = ax3.bar(x_pos, failure_counts, bottom=success_counts, color='#e74c3c', alpha=0.8, label='Failure', edgecolor='black')
