class LegacyPrinter:
    def old_print_method(self, text):
...
class PrinterBridge:
    ...
    def print_document(self, content):
        try:
            ...
            result = self._legacy_printer.old_print_method(content)
            return result
...
class DocumentManager:
    ...
    def print_to_all(self, content):
        results = []
        for printer in self.printers:
            result = printer.print_document(content)
...
if __name__ == "__main__":
    ...
    results = manager.print_to_all("Hello World")
