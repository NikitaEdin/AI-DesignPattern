...
if __name__ == "__main__":
    ...
    bank = BankTransferProcessor("12345678", "123456789")
    ...
    payment_system.set_processor(bank)
    print(payment_system.execute_payment(200.00))
    
    invalid_card = CreditCardProcessor("123", "12")
    payment_system.set_processor(invalid_card)
    print(payment_system.execute_payment(75.00))